...
public class CircularSeekBar extends View {
    ...
    public boolean getDraggingEnabled() {
        return mSetDraggingEnabled;
    }

    public void setDraggingEnabled(boolean mSetDraggingEnabled) {
        this.mSetDraggingEnabled = mSetDraggingEnabled;
    }

    /**
     *
     */
    private boolean mSetDraggingEnabled = true;
